...
# Adding a setter method to quantity changes the public interface of the instance
# variable, allowing users to circumvent the update_quantity method entirely.